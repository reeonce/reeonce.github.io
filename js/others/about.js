...
var durations = [
	...
	{start_time: dateFormat.parse("2014-07"), end_time: nowMonth, text: "Thinking & Learning ...", name: "thinking"}
];
...
var updateNodes = function() {
	...
	textsData[2].x = textsData[2].x - 120;
...
d3.selectAll(".career-link").on('click', function(event) {
	...
	$(".slideshow-item.activate").on('click', function(event) {
		$(this).css("-webkit-animation-name", "slideOutToRight");
		$(this).css("animation-name", "slideOutToRight");
...
if (Modernizr.cssanimations && Modernizr.svg) {
	setTimeout(function() {
		$("#welcome-overlay").css("animation-name", "fadeOut");
		$("#welcome-overlay").css("-webkit-animation-name", "fadeOut");
		setTimeout(function() {
